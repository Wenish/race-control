...
export class AppController {
  ...
  @Get('/gimu')
  getGimu(): string {
    return '<iframe width="100%" height="100%" autoplay src="http://www.youtube.com/embed/uepXPftPTaU?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
  }
}
